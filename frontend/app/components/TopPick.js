...
import { View, Pressable, Text, ImageBackground, StyleSheet, Dimensions, TouchableOpacity } from "react-native";
			...
			<TouchableOpacity onPress={handlePress}>
				<ImageBackground style={styles.card} source={restaurantPic}>
					<View style={styles.cardFooter}>
						...
						<Text style={styles.subtitleText}>{rating} {numReviews} | {DOLLADOLLABILL} </Text>
					</View>
				</ImageBackground>
			</TouchableOpacity>
		</View>
